...
public class B_CarService_UnitTest {
    ...
    public void whenSearchValidCar_thenReturnCar() {
        ...
        assertEquals(car.get().getModel(), "Beetle");
    ...
    public void whenGetAllCars_thenReturnAllCars() {
        ...
        assertEquals(allCars.get(0).getMaker(), "Volkswagen");
        assertEquals(allCars.get(1).getMaker(), "Citroen");
        assertEquals(allCars.get(2).getMaker(), "Nissan");
    ...
    public void whenGetCarDetails_ifCarExists_thenReturnCarDetails() {
        ...
        assertEquals(car.get().getMaker(), "Volkswagen");
