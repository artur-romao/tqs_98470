...
public class SetOfNaturalsTest {
    ...
    public void testAddElement() {
        ...
        assertThrows(IllegalArgumentException.class, () -> setC.add(-1), "add: natural numbers cannot be added to the set.");
    }

    @Test
    public void testAddBadArray() {
        int[] elems = new int[]{10, 20, -30};
        int[] more_elems = new int[]{10, 10, 20};
        // must fail with exception
        assertThrows(IllegalArgumentException.class, () -> setA.add(elems));

        assertThrows(IllegalArgumentException.class, () -> setA.add(more_elems), "add: cannot add duplicates.");
    }
    ...
    public void testIntersect() {
        ...
        assertTrue(setB.intersects(setD), "there is an intersection but none was reported");
    }
